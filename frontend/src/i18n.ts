...
const zhTW: Dict = {
  ...
  'login.mustChangeTitle': '需要變更密碼',
  'login.mustChangeHint': '請聯絡系統管理員協助重設您的密碼，完成後即可登入。',
...
const en: Dict = {
  ...
  'login.mustChangeTitle': 'Password change required',
  'login.mustChangeHint': 'Please contact your administrator to reset your password, then sign in again.',
