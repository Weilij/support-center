...
pub fn routes(state: Arc<AppState>) -> Router<Arc<AppState>> {
    ...
    let authed = Router::new()
        ...
        .route(
            ...
            get(handlers::recall_stats),
        )
        .route(
            "/api/system/messages/{messageId}/replies",
            get(handlers::message_replies),
        )
        .route(
        ...
        .route(
            "/api/system/integrations/{platform}/test",
        ...
        .route(
            "/api/feedback",
            post(handlers::submit_feedback).get(handlers::feedback_list),
        )
        ...
        .route(
            ...
            post(admin::config_slack),
        )
        .route(
            "/api/alert-config/channels/email",
            post(admin::config_email),
        )
        .route(
            "/api/alert-config/channels/webhook",
            post(admin::config_webhook),
        )
        .route(
        ...
        .route(
            "/api/user-experience/survey/invitation",
            get(admin::ux_survey_invitation),
        )
        ...
        .route(
            "/api/user-experience/ab-tests/{testId}/metrics",
            post(admin::ux_ab_metrics),
        )
        .route("/api/user-experience/ab-tests", post(admin::ux_ab_create))
        .route(
            "/api/user-experience/personal-dashboard",
            get(admin::ux_personal_dashboard),
        )
